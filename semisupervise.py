...
def get_metrics(real_score, predict_score, roc_x_path, roc_y_path, pr_x_path, pr_y_path):
    ...
    input_and_output.matrix_to_csv(x_ROC, roc_x_path)
    input_and_output.matrix_to_csv(y_ROC, roc_y_path)
    ...
    input_and_output.matrix_to_csv(x_PR, pr_x_path)
    input_and_output.matrix_to_csv(y_PR, pr_y_path)
